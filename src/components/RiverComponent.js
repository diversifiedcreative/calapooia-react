...
function Geography() {
	return (
		<>
			<div className="section-cont">
				<FullImg source="img/cala-head.jpg" caption="A view down the uppermost reaches of the Calapooia basin from above the headwaters. Taken on road NF520 below Tidbits Mountain" credit="2021 Diversified Creative" />
				<div className="section">
				...
				<FullImg source="img/cala-swiss-cheese.jpg" caption="A beautiful swimming hole between the small town of Holley and the lower Weyerhaeuser gate." credit="2021 Diversified Creative" />
				<div className="section">
					<p>
				...
				<FullImg source="img/cala-rail-bridge.jpg" caption="A family cools off in the Calapooia under a rail bridge between the small towns of Shedd and Tangent." credit="2021 Diversified Creative" />
				<div className="section">
					<p>Roughly one-third of the way through the Calapooia's 81-mile course, the river leaves the the narrow valleys of it's birth and empties out into the flatter, open agricultural terrain of the Willamette Valley at the town of Holley. From Holley onward, the river primarily winds through and between farm and ranch properties in the narrow earthen gorge it has carved through the ancient flood plains of the Willamette Basin.</p>
					<p>
				...
				<FullImg source="img/cala-queen.jpg" caption="Looking south along the Calapooia near the western city limits of Albany. The bridge visible is Queen Avenue, and the gravel bar visible under and past the bridge is a popular swimming hole." credit="2021 Diversified Creative" />
				<div className="section">
					<p>
				...
				<FullImg source="img/cala-mouth.jpg" caption="Looking into the mouth of Calapooia from the confluence with the Willamette River at Albany." credit="2021 Diversified Creative" />
			</div>
		</>
	);
}
